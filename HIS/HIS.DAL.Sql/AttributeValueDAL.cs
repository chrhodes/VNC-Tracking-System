...
{
    public class AttributeValueDAL : HIS.DAL.IAttributeValueDAL
    {
        private readonly static int CLASS_BASE_ERRORNUMBER = HIS.ErrorNumbers.HIS_DAL_SQL_ATTRIBUTEVALUE;
        ...
        public System.Data.IDataReader Fetch()
        {
            ...
            using (var sqlConn = ConnectionManager<SqlConnection>.GetManager("LocalDB"))
            {
                using (var sqlCmd = sqlConn.Connection.CreateCommand())
                {
                    ...
                    sqlCmd.CommandText = "AttributeValues_Select";
                    ...
                    catch (Exception ex)
                    {
                        ...
                        throw new ApplicationException("AttributeValues_Select");
                    }
                }
            }
#if TRACE
        ...
        public DateTime Update(Guid attributevalue_id, int table_id, Guid item_id, Guid typeattribute_id, string value, string who, string notes, DateTime last_changed)
        {
#if TRACE
            ...
            using (var sqlConn = ConnectionManager<SqlConnection>.GetManager("LocalDB"))
            {
                ...
                {
                    sqlCmd.CommandType = CommandType.StoredProcedure;
                    sqlCmd.CommandText = "AttributeValues_Update";
                    ...
                    catch (Exception ex)
                    {
                        ...
                        throw new ApplicationException("AttributeValues_Update");
                    }
                }
            }
#if TRACE
        ...
        public void Delete(Guid attributevalue_id, string who, string notes, DateTime last_changed)
        {
#if TRACE
            ...
            using (var sqlConn = ConnectionManager<SqlConnection>.GetManager("LocalDB"))
            {
                ...
                {
                    sqlCmd.CommandType = CommandType.StoredProcedure;
                    sqlCmd.CommandText = "AttributeValues_Delete";
                    ...
                    catch (Exception ex)
                    {
                        ...
                        throw new ApplicationException("AttributeValues_Delete");
                    }
                }
            }
#if TRACE
        ...
        public void DeleteAll(string who, string notes)
        {
            ...
            using (var sqlConn = ConnectionManager<SqlConnection>.GetManager("LocalDB"))
            {
                ...
                {
                    sqlCmd.CommandType = CommandType.StoredProcedure;
                    sqlCmd.CommandText = "AttributeValues_DeleteAll";
                    sqlCmd.Parameters.AddWithValue("@who", who);
                    sqlCmd.Parameters.AddWithValue("@notes", notes);
                    ...
                    catch (Exception ex)
                    {
                        ...
                        throw new ApplicationException("AttributeValues_DeleteAll");
                    }
                }
            }
#if TRACE
