...
{
    public class DataTypeDAL : HIS.DAL.IDataTypeDAL
    {
        private readonly static int CLASS_BASE_ERRORNUMBER = HIS.ErrorNumbers.HIS_DAL_SQL_DATATYPE;
        ...
        public System.Data.IDataReader Fetch()
        {
            ...
            using (var sqlConn = ConnectionManager<SqlConnection>.GetManager("LocalDB"))
            {
                using (var sqlCmd = sqlConn.Connection.CreateCommand())
                {
                    ...
                    sqlCmd.CommandText = "DataTypes_Select";
                    ...
                    catch (Exception ex)
                    {
                        ...
                        throw new ApplicationException("DataTypes_Select");
                    }
                }
            }
#if TRACE
        ...
        public DateTime Insert(int datatype_id, string name, string description, string who, string notes)
        {
#if TRACE
            ...
            using (var sqlConn = ConnectionManager<SqlConnection>.GetManager("LocalDB"))
            {
                ...
                {
                    sqlCmd.CommandType = CommandType.StoredProcedure;
                    sqlCmd.CommandText = "DataTypes_Insert";
                    ...
                    catch (Exception ex)
                    {
                        ...
                        throw new ApplicationException("DataType_Insert");
                    }
                }
            }
#if TRACE
        ...
        public DateTime Update(int datatype_id, string name, string description, string who, string notes, DateTime last_changed)
        {
#if TRACE
            ...
            using (var sqlConn = ConnectionManager<SqlConnection>.GetManager("LocalDB"))
            {
                ...
                {
                    sqlCmd.CommandType = CommandType.StoredProcedure;
                    sqlCmd.CommandText = "DataTypes_Update";
                    ...
                    catch (Exception ex)
                    {
                        ...
                        throw new ApplicationException("DataType_Update");
                    }
                }
            }
#if TRACE
        ...
        public void Delete(int datatype_id, string who, string notes, DateTime last_changed)
        {
#if TRACE
            ...
            using (var sqlConn = ConnectionManager<SqlConnection>.GetManager("LocalDB"))
            {
                ...
                {
                    sqlCmd.CommandType = CommandType.StoredProcedure;
                    sqlCmd.CommandText = "DataTypes_Delete";
                    ...
                    catch (Exception ex)
                    {
                        ...
                        throw new ApplicationException("DataType_Delete");
                    }
                }
            }
#if TRACE
        ...
        public void DeleteAll(string who, string notes)
        {
            ...
            using (var sqlConn = ConnectionManager<SqlConnection>.GetManager("LocalDB"))
            {
                ...
                {
                    sqlCmd.CommandType = CommandType.StoredProcedure;
                    sqlCmd.CommandText = "DataTypes_DeleteAll";
                    sqlCmd.Parameters.AddWithValue("@who", who);
                    sqlCmd.Parameters.AddWithValue("@notes", notes);
                    ...
                    catch (Exception ex)
                    {
                        ...
                        throw new ApplicationException("DataType_DeleteAll");
                    }
                }
            }
#if TRACE
