...
{
    public class AttributeDAL : HIS.DAL.IAttributeDAL
    {
        ...
        public System.Data.IDataReader Fetch()
        {
            ...
            using (var sqlConn = ConnectionManager<SqlConnection>.GetManager("LocalDB"))
            {
                using (var sqlCmd = sqlConn.Connection.CreateCommand())
                {
                    ...
                    sqlCmd.CommandText = "Attributes_Select";
                    ...
                    catch (Exception ex)
                    {
                        ...
                        throw new ApplicationException("Attributes_Select");
                    }
                }
            }
#if TRACE
        ...
        public DateTime Insert(Guid attribute_id, string name, string who, string notes)
        {
#if TRACE
            ...
            using (var sqlConn = ConnectionManager<SqlConnection>.GetManager("LocalDB"))
            {
                ...
                {
                    sqlCmd.CommandType = CommandType.StoredProcedure;
                    sqlCmd.CommandText = "Attributes_Insert";
                    ...
                    catch (Exception ex)
                    {
                        ...
                        throw new ApplicationException("Attributes_Insert");
                    }
                }
            }
#if TRACE
        ...
        public DateTime Update(Guid attribute_id, string name, string who, string notes, DateTime last_changed)
        {
#if TRACE
            ...
            using (var sqlConn = ConnectionManager<SqlConnection>.GetManager("LocalDB"))
            {
                ...
                {
                    sqlCmd.CommandType = CommandType.StoredProcedure;
                    sqlCmd.CommandText = "Attributes_Update";
                    ...
                    catch (Exception ex)
                    {
                        ...
                        throw new ApplicationException("Attributes_Update");
                    }
                }
            }
#if TRACE
        ...
        public void DeleteAll(string who, string notes)
        {
            ...
            using (var sqlConn = ConnectionManager<SqlConnection>.GetManager("LocalDB"))
            {
                ...
                {
                    sqlCmd.CommandType = CommandType.StoredProcedure;
                    sqlCmd.CommandText = "Attributes_DeleteAll";
                    sqlCmd.Parameters.AddWithValue("@who", who);
                    sqlCmd.Parameters.AddWithValue("@notes", notes);
                    ...
                    catch (Exception ex)
                    {
                        ...
                        throw new ApplicationException("Attributes_DeleteAll");
                    }
                }
            }
#if TRACE
