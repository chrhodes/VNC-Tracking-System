...
{
    public class TableDAL : HIS.DAL.ITableDAL
    {
        private readonly static int CLASS_BASE_ERRORNUMBER = HIS.ErrorNumbers.HIS_DAL_SQL_TABLE;
        ...
        public System.Data.IDataReader Fetch()
        {
            ...
            using (var sqlConn = ConnectionManager<SqlConnection>.GetManager("LocalDB"))
            {
                using (var sqlCmd = sqlConn.Connection.CreateCommand())
                {
                    ...
                    sqlCmd.CommandText = "Tables_Select";
                    ...
                    catch (Exception ex)
                    {
                        ...
                        throw new ApplicationException("Tables_Select");
                    }
                }
            }
#if TRACE
        ...
        public DateTime Insert(int table_id, string name, int version, string description, string who, string notes)
        {
#if TRACE
            ...
            using (var sqlConn = ConnectionManager<SqlConnection>.GetManager("LocalDB"))
            {
                ...
                {
                    sqlCmd.CommandType = CommandType.StoredProcedure;
                    sqlCmd.CommandText = "Tables_Insert";
                    ...
                    catch (Exception ex)
                    {
                        ...
                        throw new ApplicationException("Tables_Insert");                    	
                    }
                }
            }
#if TRACE
        ...
        public DateTime Update(int table_id, string name, int version, string description, string who, string notes, DateTime last_changed)
        {
#if TRACE
            ...
            using (var sqlConn = ConnectionManager<SqlConnection>.GetManager("LocalDB"))
            {
                ...
                {
                    sqlCmd.CommandType = CommandType.StoredProcedure;
                    sqlCmd.CommandText = "Tables_Update";
                    sqlCmd.Parameters.AddWithValue("@table_id", table_id);
                    sqlCmd.Parameters.AddWithValue("@name", name);
                    sqlCmd.Parameters.AddWithValue("@version", version);
                    sqlCmd.Parameters.AddWithValue("@description", description);
                    ...
                    catch (Exception ex)
                    {
                        ...
                        throw new ApplicationException("Tables_Update");                    	
                    }
                }
            }
#if TRACE
        ...
        public void Delete(int table_id, string who, string notes, DateTime last_changed)
        {
#if TRACE
            ...
            using (var sqlConn = ConnectionManager<SqlConnection>.GetManager("LocalDB"))
            {
                ...
                {
                    sqlCmd.CommandType = CommandType.StoredProcedure;
                    sqlCmd.CommandText = "Tables_Delete";
                    ...
                    catch (Exception ex)
                    {
                        ...
                        throw new ApplicationException("Tables_Delete");
                    }
                }
            }
#if TRACE
        ...
        public void DeleteAll(string who, string notes)
        {
            ...
            using (var sqlConn = ConnectionManager<SqlConnection>.GetManager("LocalDB"))
            {
                ...
                {
                    sqlCmd.CommandType = CommandType.StoredProcedure;
                    sqlCmd.CommandText = "Tables_DeleteAll";
                    sqlCmd.Parameters.AddWithValue("@who", who);
                    sqlCmd.Parameters.AddWithValue("@notes", notes);
                    ...
                    catch (Exception ex)
                    {
                        ...
                        throw new ApplicationException("Tables_DeleteAll");
                    }
                }
            }
#if TRACE
