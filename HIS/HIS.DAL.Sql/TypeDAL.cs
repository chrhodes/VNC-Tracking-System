...
{
    public class TypeDAL : HIS.DAL.ITypeDAL
    {
        private readonly static int CLASS_BASE_ERRORNUMBER = HIS.ErrorNumbers.HIS_DAL_SQL_TYPE;
        ...
        public System.Data.IDataReader Fetch()
        {
            ...
            using (var sqlConn = ConnectionManager<SqlConnection>.GetManager("LocalDB"))
            {
                using (var sqlCmd = sqlConn.Connection.CreateCommand())
                {
                    ...
                    sqlCmd.CommandText = "Types_Select";
                    ...
                    catch (Exception ex)
                    {
                        ...
                        throw new ApplicationException("Types_Select");
                    }
                }
            }
#if TRACE
        ...
        public DateTime Insert(Guid type_id, string name, int characteristics, int version, string description, string who, string notes)
        {
#if TRACE
            ...
            using (var sqlConn = ConnectionManager<SqlConnection>.GetManager("LocalDB"))
            {
                ...
                {
                    sqlCmd.CommandType = CommandType.StoredProcedure;
                    sqlCmd.CommandText = "Types_Insert";
                    ...
                    catch (Exception ex)
                    {
                        ...
                        throw new ApplicationException("Types_Insert");
                    }
                }
            }
#if TRACE
        ...
        public DateTime Update(Guid type_id, string name, int characteristics, int version, string description, string who, string notes, DateTime last_changed)
        {
#if TRACE
            ...
            using (var sqlConn = ConnectionManager<SqlConnection>.GetManager("LocalDB"))
            {
                ...
                {
                    sqlCmd.CommandType = CommandType.StoredProcedure;
                    sqlCmd.CommandText = "Types_Update";
                    ...
                    catch (Exception ex)
                    {
                        ...
                        throw new ApplicationException("Types_Update");
                    }
                }
            }
#if TRACE
        ...
        public void Delete(Guid type_id, string who, string notes, DateTime last_changed)
        {
#if TRACE
            ...
            using (var sqlConn = ConnectionManager<SqlConnection>.GetManager("LocalDB"))
            {
                ...
                {
                    sqlCmd.CommandType = CommandType.StoredProcedure;
                    sqlCmd.CommandText = "Types_Delete";
                    ...
                    catch (Exception ex)
                    {
                        ...
                        throw new ApplicationException("Types_Delete");
                    }
                }
            }
#if TRACE
        ...
        public void DeleteAll(string who, string notes)
        {
            ...
            using (var sqlConn = ConnectionManager<SqlConnection>.GetManager("LocalDB"))
            {
                ...
                {
                    sqlCmd.CommandType = CommandType.StoredProcedure;
                    sqlCmd.CommandText = "Types_DeleteAll";
                    sqlCmd.Parameters.AddWithValue("@who", who);
                    sqlCmd.Parameters.AddWithValue("@notes", notes);
                    ...
                    catch (Exception ex)
                    {
                        ...
                        throw new ApplicationException("Types_DeleteAll");
                    }
                }
            }
#if TRACE
