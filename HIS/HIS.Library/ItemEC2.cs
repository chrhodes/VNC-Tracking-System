...
{
    [Serializable]
    public class ItemEC2 : BusinessBase<ItemEC2>
    {
        ...
        internal static ItemEC2 New()
        {
            return DataPortal.CreateChild<ItemEC2>();
        }

        internal static ItemEC2 Get()
        {
            return DataPortal.FetchChild<ItemEC2>();
        }

        internal static ItemEC2 Get(object childData)
        {
            return DataPortal.FetchChild<ItemEC2>(childData);
        }
