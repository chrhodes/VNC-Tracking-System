...
{
    [Serializable]
    public class AttributeValuesECL :
      BusinessListBase<AttributeValuesECL, AttributeValueEC>
    {
        ...
        internal static AttributeValuesECL New()
        {
            return DataPortal.CreateChild<AttributeValuesECL>();
        }

        internal static AttributeValuesECL Get()
        {
            return DataPortal.FetchChild<AttributeValuesECL>();
        }

        internal static AttributeValuesECL Get(object childData)
        {
            return DataPortal.FetchChild<AttributeValuesECL>(childData);
        }

        private AttributeValuesECL()
        { }
