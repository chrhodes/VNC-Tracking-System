...
{
    [Serializable]
    public class ItemsECBL :
      BusinessBindingListBase<ItemsECBL, ItemEC>
    {
        ...
        internal static ItemsECBL New()
        {
            return DataPortal.CreateChild<ItemsECBL>();
        }

        internal static ItemsECBL Get()
        {
            return DataPortal.FetchChild<ItemsECBL>();
        }

        internal static ItemsECBL Get(object childData)
        {
            return DataPortal.FetchChild<ItemsECBL>(childData);
        }
