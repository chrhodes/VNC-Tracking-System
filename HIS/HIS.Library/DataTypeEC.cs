...
{
    [Serializable]
    public class DataTypeEC : BusinessBase<DataTypeEC>
    {
        private readonly static int CLASS_BASE_ERRORNUMBER = HIS.ErrorNumbers.HIS_LIBRARY_DATATYPE;
        ...
        internal static DataTypeEC NewDataTypeEC()
        {
            return DataPortal.CreateChild<DataTypeEC>();
        }

        internal static DataTypeEC GetDataTypeEC(object childData)
        {
            return DataPortal.FetchChild<DataTypeEC>(childData);
        }
