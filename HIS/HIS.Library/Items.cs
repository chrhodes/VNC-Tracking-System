...
namespace HIS.Library
{
    ...
    public class Items : BusinessBindingListBase<Items, Item>
    {
        ...
        internal static Items NewEditableChildBindingList()
        {
            return DataPortal.CreateChild<Items>();
        }

        internal static Items GetEditableChildBindingList()
        {
            return DataPortal.FetchChild<Items>();
        }

        internal static Items GetEditableChildBindingList(object childData)
        {
            return DataPortal.FetchChild<Items>(childData);
        }
        ...
        private void Child_Fetch()
        {
            ...
            using (var dalManager = HIS.DAL.DALFactory.GetManager())
            {
                ...
                using (var data = dal.Fetch())
                {
                    while (data.Read())
                    {
                        var item = DataPortal.FetchChild<Item>(data);
                        Add(item);
                    }
                }
            }
        ...
        private void Child_Fetch(object childData)
        {
            ...
            {
                var item = DataPortal.FetchChild<Item>(childData);
                Add(item);
            }
